...
namespace Utilities.Exceptions
{
    ...
    public class EntityNotFoundException : BusinessException
    {
        ...
        public EntityNotFoundException(string entityType, object entityId) : base($"La entidad '{entityType}' con ID '{entityId}' no fue encontrada")
        {
    ...
    public class BusinessRuleViolationException : BusinessException
    {
        ...
        public BusinessRuleViolationException(string ruleCode, string message) : base($"Violación de regla de negocio [{ruleCode}]: {message}")
        {
            RuleCode = ruleCode;
        }
    ...
    public class UnauthorizedAccessBusinessException : BusinessException
    {
        ...
        public UnauthorizedAccessBusinessException(string resource, string operation) : base($"Acceso no autorizado al recurso '{resource}' para la opración '{operation}'.")
        {
            Resource = resource;
            Operation = operation;
        }
